 ...
 *
 * "Saved briefs" is the discovery-brief switcher, named in full so it does
 * not read as the same thing as the Creative brief in the tool list.
 */
...
export const TOOL_COUNT = TOOLS.length + API_TOOLS.length;
